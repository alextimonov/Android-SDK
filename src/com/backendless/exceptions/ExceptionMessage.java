...
public class ExceptionMessage
{
  ...
  public final static String GCM_SENDER_ID_NOT_DECLARED = "GcmSenderId meta-data is not properly declared in android manifest. It should be declared in receiver section in next format <meta-data android:name=\"GCMSenderId\" android:value=\"some_valueL\" />. Note your value should ends with 'L' character";
